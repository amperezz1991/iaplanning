...
public class IA_PLANNING extends javax.swing.JFrame {
    ...
    public static Boolean elijioMFCont = false;
    ...
    private void initComponents() {
        ...
        jLstMF.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLstMFMouseClicked(evt);
            }
        });
    ...
    private void jBGuardarEstadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuardarEstadoActionPerformed
        ...
        advertencia = ("Informacion de lista de Estados GUARDADA en memoria interna");
    ...
    */
    ...
    private void jBEliminarMAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEliminarMAActionPerformed
        ...
        if (pos>=0){
            ...
            advertencia = ("Recuerda GUARDAR la nueva información");
        }else{
            advertencia = ("No Hay o no ha elejido ningun Elementos en la lista para eliminar.");
        }
        cargarListas();
    ...
    private void jBGuardarMAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuardarMAActionPerformed
        ...
        advertencia = ("Informacion de lista del Mundo Actual GUARDADA en memoria interna " + MundoActual.mundoActual.toString());
    ...
    private void jBEliminarMFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBEliminarMFActionPerformed
        int pos=0;
        if (elijioMFCont){
            pos = this.jLstMF.getSelectedIndex();
        }else{
            if (elijioMF){
                pos = this.jLstEstMF.getSelectedIndex();
            }
        }
    ...
    private void jBGuardarMFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGuardarMFActionPerformed
        ...
        advertencia = ("Informacion de lista del Mundo Final GUARDADA en memoria interna " + MundoFinal.mundoFinal.toString());
        cargarListas();
    ...
    private void jLstMFMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLstMFMouseClicked
        // TODO add your handling code here:
        int pos = jLstMF.getSelectedIndex();
        if (pos > -1){
            elijioMFCont = true;
            jTDefMF.setText(listaMundoFinal.get(pos).toString());
        }
    }//GEN-LAST:event_jLstMFMouseClicked
